        ...
        <div className="flex flex-col gap-3.5">
          ...
          <form onSubmit={handleJoin} className="flex gap-2">
            <input
              ...
              className="flex-1 bg-white/4 border border-white/5 rounded-xl px-3 py-2 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-white/10 transition-all font-medium uppercase"
            />
            <button
              type="submit"
              className="px-4 py-2 bg-white/5 border border-white/10 hover:bg-white/8 rounded-xl text-xs font-medium text-white transition-all cursor-pointer"
            >
              Join
            </button>
          </form>
